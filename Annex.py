...
class Weather:
    def show(self,scrollable_text):
        SR=SpeakRecog(scrollable_text)
        base_url = "https://api.openweathermap.org/data/3.0/onecall?lat=27.7107365&lon=-85.3226848&appid=e3bedd2fa53d230cdb51cd54a6efae14"
        data=requests.get(base_url).json()
        SR.scrollable_text_clearing()
        SR.speak("-----------------------------Weather Report of Kathmandu City------------------------------")
